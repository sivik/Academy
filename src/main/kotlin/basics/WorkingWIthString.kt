...
fun concatAndInterpolation(){
    ...
    //string format
    println("%s jakby to powiedzieć %s chociaz to dziwne %s".format(start,mid,end)) // //Konsumpcja zwierząt jakby to powiedzieć  jest średnio szkodliwa dla środowiska chociaz to dziwne  ale surowe mięsko lubię
    //interpolacja
